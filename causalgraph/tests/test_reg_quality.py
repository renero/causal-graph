...
# Tests that the method returns the correct indices of features that are both gamma and outliers for a list of scores with length > 1
...
# Tests that the method returns the correct indices of features that are both gamma and outliers when all scores are outliers
...
# Tests that the method returns the correct indices of features that are both gamma and outliers when all scores are gamma
